...
// delete operator only for properties
delete student.firstName;

// :: = bind doesn't supported at node.js yet

console.log(2 ** 5); // 32 2 (Math.pow operator)



// Conditionally access properties with ?. (ES2020):
//student?.firstName? // =>  check for isHasOwnProperty
